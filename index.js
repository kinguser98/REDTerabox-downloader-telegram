async function main() {
  ...
  bot.start(async (ctx) => {
    try {
      ctx.reply(
        `Hi ${ctx.message.from.first_name},\n\nU can Download Files from Terabox.\n\nMade with ❤️ by @teamredinfinity\n\nSend any terabox link to download.`,
        Markup.inlineKeyboard([
          Markup.button.url(" Owner", "https://t.me/teamredinfinity"),
          Markup.button.url("Report bug", "https://t.me/teamredinfinity"),
        ]),
      );
    } catch (e) {
      console.error(e);
